...
> [!NOTE]
> Markdown cannot execute commands directly. Use the copy button on each code block, paste the command into a terminal, and keep the same Copilot session open for Steps 3 through 6.
...
Ask Copilot to correct any missing configuration, then exit:
