...
> [!NOTE]
> Markdown cannot execute code cells directly. Use the copy button on each code block, paste the command into a terminal, and keep the same Copilot session open for Cells 2 and 3.
...
For the compact documentation version, see [recipe.md](./recipe.md).
